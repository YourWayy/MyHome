import { createElement, Fragment, createRef, PureComponent } from 'react';
...
var BigBangStarField = /** @class */ (function (_super) {
    ...
    BigBangStarField.prototype.render = function () {
        ...
        var div = createElement(Fragment, null,
            createElement("div", __assign({ className: 'BigBangStarFieldContainer', ref: this.containerRef, style: __assign({ width: '100%', height: '100%', overflow: 'hidden' }, style) }, rest),
                createElement("canvas", { ref: this.canvasRef, width: this.state.containerWidth, height: this.state.containerHeight })));
        return div;
    };
